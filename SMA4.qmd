...
::: {.column width=60% .r-fit-text}
### ... en 2026
![](img4/SMA2026_rnk.jpg){width=600}
Source : **Etudiants UPC, 2026**, Cours de L3 Geo *Structures du Monde Actuel*
:::
::::
...
:::: {.columns}
::: {.column width=30% .r-fit-text}
![](img4/SMA_like_2026.jpeg){width=300}

Source : étudiants L3 SMA, 2026
:::

::: {.column width=70% .r-fit-text}
![](img4/Paris.jpg){width=300}
![](img4/london.jpg){width=200}

![](img4/madrid.jpg){width=150}
![](img4/NewYork.jpg){width=150}
![](img4/rio.jpg){width=150}
![](img4/lalaland.jpg){width=150}
![](img4/oslo.jpg){width=100}
...
:::: {.columns}
::: {.column width=30% .r-fit-text}
![](img4/SMA_unlike_2026.jpg){width=300}

Source : étudiants L3 SMA, 2026
:::

::: {.column width=70% .r-fit-text}
![](img4/Dubai.jpg){width=300}
![](img4/Moscow.jpg){width=250}

![](img4/Kabul.jpg){width=250}
![](img4/marseille_quartier.jpg){width=250}

![](img4/mumbai.jpg){width=100}
![](img4/telaviv.jpg){width=150}
...
![](img4/SMA_tot_2026.jpg){width=800}
...
## Existe-t-il une théorie universelle de la ville...
:::: {.columns}
::: {.column width=20% .r-fit-text}
![](img4/Scott_AJ.jpg){width=150}

**Scott A.J., 2012**, *A World in Emergence : Cities and regions in the 21st Century*, Chap.2  "On urbanization and urban theory", Edward Elgar, Los Angeles
:::

::: {.column width=80% .r-fit-text}

### Universalité de l'urbanisation et variétés du capitalisme
Je soutiens que toute théorie cohérente de l'urbanisation pertinente dans le contexte actuel doit être dérivée de la logique et de la dynamique du capitalisme dans son ensemble. De même, les ajustements détaillés à toute théorie de ce type doivent également être effectués en fonction des versions du capitalisme qui prévalent à des moments précis et dans des lieux précis.

### Une théorie "occidentale" ?
Je soulève ce point en partie parce qu'il existe aujourd'hui un sentiment croissant de malaise dans une grande partie de la littérature concernant l'application des théories « occidentales » de l'urbanisation aux situations dans les pays du Sud, et un certain scepticisme quant à la capacité d'une théorie générale à rendre justice à l'ensemble des résultats sociaux et urbains à travers le monde (Escobar 2005 ; McGee 1967 ; Robinson 2006 ; Roy 2011).
...
## ... ou faut-il adopter une approche critique et postcoloniale ?
:::: {.columns}
::: {.column width=20% .r-fit-text}
![](img3/ordinary_cities.jpg){width=200}
...
![](img4/robinson_video.jpg){width=700}

Source : [Jennifer Robinson y las Ciudades Ordinarias: Desafiando las Teorías Urbanas ](https://www.youtube.com/watch?v=8OVaMJxMDCY)
:::
::::

## Débat sur la relocalisation des institutions des Nations Unies

:::: {.columns}
::: {.column width=50% .r-fit-text}
![](img4/geneva.jpg){width=400}
:::

::: {.column width=50% .r-fit-text}

![](img4/UNheadquarters.jpg){width=500}
:::
::::
